...
public class SourceCodeEditor extends SyntaxTextPane
{
    ...
    public SourceCodeEditor()
    {
        ...
        try
        {
            //in = getClass().getResource("src"+File.separator+"org"+File.separator+"milaifontanals"+File.separator+"wikiloc"+File.separator+"htmleditor"+File.separator+"net"+File.separator+"atlanticbb"+File.separator+"tantlinger"+File.separator+"ui"+File.separator+"text"+File.separator+"syntax.properties").openStream();
            Object o = null;
