...
import org.milaifontanals.wikiloc.breadcrumb.com.raven.shadow.ShadowRenderer;
...
public class Breadcrumb extends javax.swing.JPanel {
    ...
    public Breadcrumb() {
        ...
        home.setEvent(new EventItemSelected() {
            ...
            public void selected(BreadcrumbItem item) {
                itemSelected = item;
                repaint();
                //System.out.println("Selected home Index: " + item.getIndex());
                if(event != null){
                    event.selected(item);
                }
            }
    ...
    private void initComponents() {
        ...
        home = new org.milaifontanals.wikiloc.breadcrumb.com.raven.component.Home();
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        if(itemSelected != null){
            ...
            GradientPaint gra1 = new GradientPaint(0,margin,new Color(colorSelected.getRed(),colorSelected.getGreen(),colorSelected.getBlue(),100),0,height/2,new Color(0,0,0));
            g.setPaint(gra1);
            g.fillPolygon(xx,yy,xx.length);
            //draw color bot to top
            GradientPaint gra2 = new GradientPaint(0,height+margin,new Color(colorSelected.getRed(),colorSelected.getGreen(),colorSelected.getBlue(),100),0,height/2,new Color(0,0,0));
            g.setPaint(gra2);
            g.fillPolygon(xx,yy,xx.length);
        }
    ...
    public void addItem(String name){
        ...
        item.setEvent(new EventItemSelected() {
            ...
            public void selected(BreadcrumbItem item) {
                itemSelected = item;
                repaint();
                //System.out.println("Selected item Index: " + item.getIndex());
                if(event != null){
                    event.selected(item);
                }
            }
    ...
    private org.milaifontanals.wikiloc.breadcrumb.com.raven.component.Home home;
